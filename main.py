...
def insertintotable():
    ...
    try:
        nm = request.form['nm']
        print(">>> Received ticker:", nm)
    except Exception as e:
        print(">>> ERROR reading ticker:", e)
        return render_template('index.html', not_found=True)

    quote = nm.strip().upper()
    ...
    # Continue with your ARIMA, LSTM, etc...
    ...
    def get_historical(quote):
        ...
        print(f">>> yfinance returned {len(data)} rows")
    ...
    # If yfinance fails, try Alpha Vantage
        if df.empty:
            ...
            try:
                ...
                print(">>> Alpha Vantage data saved successfully.")
            except Exception as e:
